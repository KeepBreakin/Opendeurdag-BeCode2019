...
function checkExercise() {
  for (let i = 0; i < created_elements.childElementCount; i++) {
      for (let j = 0; j < exercise_elements.childElementCount; j++) {
          console.log(created_elements.children[i].firstElementChild.innerHTML.replace(/\s+/g, ''));
          console.log(exercise_elements.children[j].firstElementChild.innerHTML.replace(/\s+/g, ''));
